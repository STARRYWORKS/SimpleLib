...
if ( typeof("SimpleLib") != "undefined" ) {
	var pluginInfo = {
		settings: {
			...
			imageBtnNext: SimpleLib.jsDir + "plugins/lightBox/lightbox-btn-next.gif",
			cssPath: SimpleLib.jsDir+'plugins/lightBox/jquery.lightbox-0.5.css',
	...
	SimpleLib.extend( "lightBox", pluginInfo );
}