...
typeof c.button=="function"?(c.button("selected",!1),d.button("selected",!0)):(c.removeClass(a.selectedClass),d.addClass(a.selectedClass));return!1});c.each(function(){b(this).hasClass(a.selectedClass)&&(d=b(this),b(this).trigger(a.trigger))});typeof c.button=="function"&&c.button({over:a.over,out:a.out,down:a.down,up:a.up,selected:a.selected,enableMouseEvents:a.enableMouseEvents,enableMouseEventsSelected:a.enableMouseEventsSelected,postfix:a.postfix,fade:a.fade,fadeTime:a.fadeTime});d==null&&(d=
b(c[0]));d.trigger(a.trigger);return this}})(jQuery);
/* SimpleLib Plugin */
